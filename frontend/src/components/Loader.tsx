...
export const CustomDeanPageLoader = ({ size = 32, className = "" }) => {
  return (
    <div className="flex w-full flex-col gap-1  h-[calc(100vh-90px)] justify-center items-center">
      <Loader className={`animate-spin ${className}`} size={size} />
      <p className="text-custom-grey text-center">Analyzing your credit report</p>
    </div>
  );
};